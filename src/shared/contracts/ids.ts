...
export type RunnerPairingId = Brand<string, "RunnerPairingId">;
export type RunnerCredentialId = Brand<string, "RunnerCredentialId">;
export type RunnerMappingId = Brand<string, "RunnerMappingId">;
export type SafeProfileId = Brand<string, "SafeProfileId">;
export type ExposureAcknowledgementId = Brand<string, "ExposureAcknowledgementId">;
...
export type MutationLeaseId = Brand<string, "MutationLeaseId">;
